...
function ContactPage() {
  return (
    <div className='h-[70vh] bg-primary'>
      ...
      <div className='mt-8 grid-cols-1 grid lg:grid-cols-2 xl:grid-cols-3 place-items-center'>
        {/* Information Details */}
        <div className='flex justify-center relative w-full items-center h-full'> 
            ...
            <div className='hidden lg:block absolute right-[0px] top-[10px] h-[100%] border-[1px] border-white'>  </div>
        ...
        <div className='w-full items-center relative text-center flex flex-col justify-center'>
            ...
            <h1 className='hidden xl:block text-white tracking-widest text-[16px] mt-4'> Caring for plants enhances your space with life. <br/>
        ...
        {/* Pages */}
        <div className='mt-4 lg:mt-0 lg:hidden xl:block flex flex-col items-center justify-center'>
      ...
      <div className='flex justify-center relative'>
        <div className='absolute mt-8 w-[80%] sm:w-[60%]  border-[1px] border-white'>  </div>
